...
url = 'http://www.lninfo.gov.cn/cxpt/zdsys/201804/t20180428_3238140.html'
list_information = []
...
print(dataFrame)
dataFrame.to_csv('./辽宁省重点实验室.csv',encoding='gbk')

def csv_to_xlsx_pd():
    csv = pd.read_csv('辽宁省重点实验室.csv', encoding='gbk')
    csv.to_excel('辽宁省重点实验室.xlsx', sheet_name='data')
